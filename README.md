# Shlok — 3D portfolio (Vite)

Personal site for **Shlok Kumar**, forked from **[akashrmalhotra/3d-portfolio](https://github.com/akashrmalhotra/3d-portfolio)** (MIT): React 18, TypeScript, Three.js / R3F, GSAP ScrollTrigger + ScrollSmoother, and scroll-driven 3D scenes.

Upstream reference: [akashrmalhotra.netlify.app](https://akashrmalhotra.netlify.app/)
...
- **Identity & links**: `src/data/profile.ts` (email, GitHub, LinkedIn, certifications URL, initials).
